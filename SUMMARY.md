...
- ✅ `google-callback.php` - OAuth callback handler & token management
- ✅ `drive-storage.php` - Get storage account info
...
- ✅ `drive-account.php` - Google Drive storage account info 🆕
...
- ✅ `INSTALL.md` - Quick in
- ✅ `docs/CHANGE_STORAGE_ACCOUNT.md` - Hướng dẫn chuyển đổi Storage Account 🆕stallation guide
- ✅ `SUMMARY.md` - File này
...
- **Storage Account Management** 🆕
  - Separate OAuth App & Storage accounts
  - Switch storage account without changing OAuth config
  - View current storage account info
  - One-click token deletion & re-authentication
